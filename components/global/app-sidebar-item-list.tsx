        ...
        items: [
            {
                ...
                icon: Code,
                instructions: "Reference for Web Development concepts, tools, and best practices.",
            ...
            },
            {
                ...
                icon: ToolCase,
                instructions: "Reference for developer tools concepts, tools, and best practices.",
            ...
            },
            {
                ...
                icon: Paintbrush,
                instructions: "Reference for design concepts, tools, and best practices.",
                searchTerms: ["color", "color theory", "typography", "ui", "ux", "dev", "designer"],
            },
            {
                title: "Databases",
                url: "/modules/reference/databases",
                icon: Paintbrush,
                instructions: "Reference for design concepts, tools, and best practices.",
                searchTerms: ["databases", "backend developer", "sql", "nosql", "data storage"],
            },
            {
                title: "Testing",
                url: "/modules/reference/testing",
                icon: Paintbrush,
                instructions: "Reference for testing concepts, tools, and best practices.",
                searchTerms: [
                    "testing",
                    "software tester",
                    "unit tests",
